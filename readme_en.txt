...
Step 4: PHP (with mod_php, as *.php), Perl by default with *.cgi, SSI with *.shtml are all located in => D:\\xampp\htdocs\.
Examples:
- D:\\xampp\htdocs\test.php => http://localhost/test.php
- D:\\xampp\htdocs\myhome\test.php => http://localhost/myhome/test.php
...
(1) The MySQL server can be started by double-clicking (executing) mysql_start.bat. This file can be found in the same folder you installed XAMPP in, most likely this will be D:\\xampp\.
...
To set the passwort "secret" for the user "root", type the following:
	...
	D:\\xampp\mysql\bin\mysqladmin.exe -u root -p secret
