...
upgrade to the latest available patch level. Currently:
    ...
    vac.C     4.4.0.4  or 5.0.2.6 or 6.0.0.1
...
If you've chosen to use vac 4, be sure to run 4.4.0.4. Older versions
...
cumulative.
 ...
 vac.C.4.4.0.1 => vac.C.4.4.0.4  is OK     (vac.C.4.4.0.2 not needed)
